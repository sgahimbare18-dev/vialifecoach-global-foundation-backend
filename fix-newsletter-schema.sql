-- Fix Newsletter Schema - Add unsubscribe_token column
-- Run this in your Supabase SQL Editor to fix the newsletter table schema
...
BEGIN
    IF NOT EXISTS (
        ...
        SET unsubscribe_token = encode(md5(email || now()::text), 'hex')
