  ...
  try {
    ...
    for (const module of modules) {
      const result = await pool.query(
        'INSERT INTO modules (course_id, title, description, order_index, published, quiz_required, min_pass_percentage, updated_at) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING *',
        [1, module.title, module.description, module.order_index, true, false, 80, new Date()]
      );
      console.log('✅ Added module:', result.rows[0]);
    }
