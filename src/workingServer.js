...
app.get('/test', (req, res) => {
  res.json({ message: 'Working Vialifecoach Academy Server!' });
});

// Generate simple slide HTML (without FFmpeg)
app.post('/api/v1/video-generation/generate-video', async (req, res) => {
  try {
    ...
    // Create a simple HTML slide for demo
    const slideHTML = `
<!DOCTYPE html>
<html>
<head>
...
<body>
    <div class="slide">
        <div class="slide-number">Lesson 1</div>
        <div class="title">The Confidence Code: Building Unstoppable Self-Belief</div>
        <div class="content">How Confidence Begins in the Mind</div>
...
const PORT = 5000;
app.listen(PORT, () => {
  console.log(`🚀 Vialifecoach Academy Video Generation Server running on http://localhost:${PORT}`);
